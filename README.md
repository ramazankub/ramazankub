...
### 📱 Android Mobile Automation (Appium)
**Tech:** Java 21, Appium 2.x, UIAutomator2, JUnit 5, Selenide, Gradle, Allure  

- Clean Page Object architecture
- Parameterized tests for negative scenarios
- Gesture-based interactions (scroll / swipe)
- Capabilities via properties files
